  ...
  return <>
    ...
    <dialog ref={dialog} aria-labelledby={title} onClose={() => { opener.current?.focus(); }} className="help-dialog">
      ...
      {engineering ? <div className="space-y-4 text-sm leading-relaxed">
        ...
        <p>Start with $1,000,000 of pretend money. Play five days. Make up to three purchases each day, sharing an allowance of half your cash at the start of that day. Cashing out does not refill the allowance or restore a purchase. Buy only whole tickets. Sitting out is a valid choice.</p>
