...
import { parseLandingStats, statNumber } from './publicStats';
...
describe('landing statistics', () => {
  it('formats profit cents without including an opening balance or losing integer precision', () => {
    ...
    expect(statNumber('501728953729911', true)).toEqual({
      compact: '+$5.02T',
      exact: '+$5,017,289,537,299.11',
    });
