  ...
  return (
    <div className="day-result flex min-h-full flex-col gap-[18px] short:gap-3.5">
      <h2 className="ticket-panel-heading ticket-mascot-heading m-0">
        Closing bell <RoboPup key={frame.clock.day} pose="bell" active={result !== undefined} />
      </h2>
      <div className="ticket-content">
        <div className="flex flex-col gap-1.5">
          ...
          <div
            className={cx(
              'font-display text-[38px] leading-tight font-extrabold tabular-nums short:text-[32px]',
