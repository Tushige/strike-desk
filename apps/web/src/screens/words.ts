...
export const startWords = {
  ...
  footer:
    'Fictional companies. Pretend money. Real trading ideas. For teachers: an UP ticket is a call option, a DOWN ticket is a put option, the target is the strike price, and the closing bell is expiry.',
  example:
...
export const RANKS: readonly Rank[] = [
  ...
  },
  {
    ...
    blurb:
      'You finished with less than you started. The market took a bite, but you are still standing.',
  },
  {
    minCents: -Infinity,
