...
export const startWords = {
    ...
    footer: "Made-up companies. Pretend money. Real trading ideas. For teachers: an UP ticket is a call option, a DOWN ticket is a put option, the target is the strike price, and the closing bell is expiry.",
    example:
...
export const finalWords = {
    ...
    more: (amount: string): string =>
        `${amount} more than the $1,000,000 you started with`,
    less: (amount: string): string =>
        `${amount} less than the $1,000,000 you started with`,
    ...
    marketHint:
        "This number recreates the exact same market. Traders call it a seed.",
} as const;
...
export const RANKS: readonly Rank[] = [
    {
        minCents: 300_000_000,
        title: "Desk Legend",
        blurb: "You more than tripled the desk. Big swings, big nerve.",
    },
    {
        minCents: 150_000_000,
        title: "Sharp Trader",
        blurb: "You grew the desk by half or more. You read the news well and sized your bets.",
    },
    {
        minCents: 100_000_000,
        title: "Steady Hand",
        blurb: "You kept the desk alive and a little ahead. That is harder than it sounds.",
    },
    {
        minCents: 50_000_000,
        title: "Bruised Rookie",
        blurb: "You finished with less than you started. The market took a bite, but you are still standing.",
    },
    {
        minCents: -Infinity,
        title: "Back to Training",
        blurb: "Over half the desk is gone. Every great trader has a day like this. Go again.",
    },
];
...
export function rankFor(finalCents: number): Rank {
    return (
        RANKS.find((rank) => finalCents >= rank.minCents) ??
